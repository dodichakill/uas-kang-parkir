<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] != "PATCH" || empty($_GET["uuid"]) || empty($input_data["username"]) || empty($input_data["password"]) || empty($input_data["nama"]) || empty($input_data["gender"]) || empty($input_data["no_telp"]) || empty($input_data["alamat"]) || empty($input_data["level"])) {
